...
# Raise the log level for PyMongo to WARNING to suppress debug/heartbeat logs
logging.getLogger("pymongo").setLevel(logging.WARNING)
# Load env variables early
env_path = Path(__file__).parent / '.env'
load_dotenv(dotenv_path=env_path)

# Global static data holders
IDF_DATA = {}
...
app.logger.info(f"mongo.db in create_app: {mongo.db}")
